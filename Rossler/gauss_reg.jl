...
fname           = "gaussian_sparse_prune_results"
fname_mlp       = "LV_MLP"
add_path        = "post_plots/"
...
activations_x, activations_y, activations_z, activations_second, LV_samples_lay1,=activation_getter_3x3(pM_, pM_new, kan1, grid_size)

#######symbolic regression:
inputs_lay1=X
activations_lay1_x=activations_x
activations_lay1_y=activations_y
activations_lay1_z=activations_z
...
hallOfFame = EquationSearch(inputs_lay1[3, :]', activations_lay1_z', niterations=100, options=options)
