...
elseif is_pruned==false
    load_file=dir*add_path_kan*"checkpoints/"*fname*"_results_reg1e_5_sparse.mat"
end
...
##otherwise skip directly to contour plots
    ...
    for i in 1:layer_width
        ...
        png(plt, string(dir*add_path, "activation_plots/X", string(i), "_$(prune_level).png"))
        ...
        png(plt, string(dir*add_path, "activation_plots/Y", string(i), "_$(prune_level).png"))
        ...
        png(plt, string(dir*add_path, "activation_plots/X_symb_", string(i), "_$(prune_level).png"))
        ...
        png(plt, string(dir*add_path, "activation_plots/Y_symb_", string(i), "_$(prune_level).png"))
    end
    ...
    for i in 1:layer_width
        ...
        png(plt, string(dir*add_path, "activation_plots/second_", string(i), "_to_X_$(prune_level).png"))
        ...
        png(plt, string(dir*add_path, "activation_plots/second_", string(i), "_to_Y_$(prune_level).png"))
        ...
        png(plt, string(dir*add_path, "activation_plots/second_symb_", string(i), "_to_X_$(prune_level).png"))
        ...
        png(plt, string(dir*add_path, "activation_plots/second_symb_", string(i), "_to_Y_$(prune_level).png"))
