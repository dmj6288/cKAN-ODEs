...
function prune(p, kan_curr, layer_width, grid_size, pM_axis, theta=1e-4)
...
function plot_save(l, l_test, p_list, epoch)
    ...
    pred_sol_true = solve(ODEProblem(Fitz!, u0, tspan, p_), Tsit5(), abstol = 1e-12, reltol = 1e-12, saveat = timestep)
