...
fname           = "rbf_results_reg1e_5_prune_results"
fname_mlp       = "LV_MLP"
add_path        = "post_plots/"
...
hallOfFame = EquationSearch(inputs_lay1[1, :]', activations_lay1_x[:, 5]', niterations=100, options=options)
hallOfFame = EquationSearch(inputs_lay1[1, :]', activations_lay1_x[:, 7]', niterations=100, options=options)

hallOfFame = EquationSearch(inputs_lay1[2, :]', activations_lay1_y[:, 1]', niterations=100, options=options)
hallOfFame = EquationSearch(inputs_lay1[2, :]', activations_lay1_y[:, 5]', niterations=100, options=options)
hallOfFame = EquationSearch(inputs_lay1[2, :]', activations_lay1_y[:, 7]', niterations=100, options=options)
...
hallOfFame = EquationSearch(inputs_lay2[7, :]', activations_lay2[13, :]', niterations=100, options=options)
hallOfFame = EquationSearch(inputs_lay2[7, :]', activations_lay2[14, :]', niterations=100, options=options)
